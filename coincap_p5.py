...
#crypto_workbook = xlsxwriter.Workbook(r'C:\Users\kyle.lin\Desktop\crypto.xlsx')
crypto_workbook = xlsxwriter.Workbook('crypto.xlsx')
...
for i in range(10):
    ticker_url = 'https://api.coinmarketcap.com/v2/ticker/?structure=array&start=' + \
        str(start)
